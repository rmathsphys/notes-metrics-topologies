...
\begin{nprop}
  Topological spaces with the discrete topology are metrizable; using the discrete metric.
\end{nprop}
...
The product topology is consistent with the definition of metrics on a product space we defined earlier.
